...
# Last modified: 2016-11-15 15:23
# Filename: frames.py
# Description:
__metaclass__ = type
...
class ConsFrame(wx.Frame):
    ...
    def _init_addrs(self):
        self.addrs_panel = wx.ScrolledWindow(
            ...
            name="addrs_panel")
        self.addrs_panel.SetMinSize((200, 600))
    ...
    def _init_progress_panel(self):
        self.progress_panel = wx.ScrolledWindow(
            ...
            style=wx.VSCROLL,
            name="progress_panel")
        self.progress_panel.SetMinSize((600, 550))
    ...
    def _init_right_btns(self):
        ...
        btns_panel.SetMinSize((600, 50))
        btns_panel.SetMaxSize((600, 50))
        btns_layout = wx.BoxSizer(wx.HORIZONTAL)
        btns_panel.SetSizer(btns_layout)

        self.right_layout.Add(btns_panel, 0, wx.ALL | wx.ALIGN_BOTTOM, 5)

        send_btn = wx.Button(btns_panel, -1, u'发送', size=(100, 40))
