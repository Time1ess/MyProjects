...
# Last modified: 2016-11-15 10:54
...
class Coordinator:
    ...
    def message_hook(self, cli_msg, svr_msg, sender_host, sender_port):
        self.msg_lock.acquire()
        self.msgs.append((cli_msg, svr_msg, sender_host, sender_port))
    ...
    def _handle_message(self):
        ...
        if not self.msgs:
            ...
            cli_msg, svr_msg, host, port = self.msgs.pop(0)
            self.msg_lock.release()
